    ...
    <title></title>
            ...
            <body>
                         ...
                         <!-- <li class="nav-item"> -->
                            ...
                            <!-- href="tampil_masyarakat.php">DATA user</a> -->
                            </li>
                            

                            <li class="nav-item">
                            <a class="nav-link" aria-current="page"
                            href="tampil_barang.php">DATA Barang</a>
                            </li>
                            
                            
                            <!-- <li class="nav-item"> -->
                            <!-- <a class="nav-link" aria-current="page" -->
                            <!-- href="tampil_petugas.php">DATA Petugas</a> -->
                            </li>
                
                            <li class="nav-item">
                            <a class="nav-link" aria-current="page"
                            href="histori_transaksi.php">Transaksi</a>
                            </li>
